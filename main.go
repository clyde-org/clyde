...
type RegistryCmd struct {
	...
	IncludeImages				 []string	   `arg:"--include-images,env:INCLUDE_IMAGES" default:"" help:"List of images to include and the system would look for and download automatically."`
